...
object (FBO).
Rendering the scene to a texture requires an FBO with a texture attached for the
color buffer and a render buffer object (RBO) attached for the depth buffer.
