...
// - #include is the C preprocessor. it lets you add functionallity to your
// program.
// - including iostream gets us std::cout and std::endl
// - functions have name, return type, arguments, body/block in curly braces
// executed
// - main() is a function that special: it's called by the operating system to
// start your program
// - C++ has a stream operator (i.e., <<). cout is the name of the thing that
